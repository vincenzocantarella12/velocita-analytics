...
# BICICLETTE INIZIALI     # Sono state inserite alcune biciclette già presenti nella flotta per simulare un sistema reale già avviato.
...
# STATISTICHE FLOTTA
        ...
        print(f"Totale biciclette: {totale}")
        print(f"Biciclette disponibili: {disponibili}")
        print(f"Biciclette in uso: {in_uso}")
...
# Questo file rappresenta il punto di avvio del progetto.
# Tramite un menu interattivo è possibile utilizzare
# le principali funzionalità del sistema VeloCittà.
...
# Il menu utilizza un ciclo while
# per mantenere il programma attivo
# fino alla scelta di uscita.


# Biciclette iniziali del sistema


# Questo permette di testare immediatamente:
# - ricerca biciclette
# - noleggio e restituzione
# - statistiche della flotta
# - stampa degli oggetti

# Inoltre il menu non parte con una flotta vuota,
# rendendo il programma più completo e realistico.